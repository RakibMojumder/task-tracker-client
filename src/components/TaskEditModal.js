...
const TaskEditModal = ({ setShowModal }) => {
    return (
        <div className='absolute h-full w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
            <div className="relative flex justify-center">
                ...
                <div
                >
                    <div className="w-[500px] flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
                            ...
                            <form className="mt-4" action="#">
                                ...
                                <div className="mt-4 sm:flex sm:items-center sm:-mx-2">
                                    <button onClick={() => setShowModal(false)} type="button" className="w-full px-4 py-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:w-1/2 sm:mx-2 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
                                        Cancel
                                    </button>
